...
if __name__ == '__main__':
    N =25
    C = np.eye(N,N)
    weight = np.array([-0.48514596 , 0.54877189 ,-0.12309621 , 0.78651032, -2.1058589  , 0.60574968,
  0.33917088,  0.59702643, -0.04239731,  0.04074819, -0.58833682, -0.84127145,
 -0.92781116,  0.62605019,  0.3916471,   1.62988963,  0.72966228,  0.45008467,
 -0.98849795, -0.31552804,  1.54685271,  0.34410672,  1.56943979, -1.16607165,
 -1.62169502])
    Aeq = np.ones(N)
    beq = np.ones(1)
    lb = np.zeros(N)
    ...
    weight = lsqlin(C, weight, reg=0, A=None, b=None, Aeq=Aeq, beq=beq, \
        lb=lb, ub=ub, x0=weight, opts=None)
